...
Consigna	
* Con React, React Router armar una Web App que muestre en la pantalla principal el listado de paises y ciudades. Mostrar la cantidad de ciudades.
...
* Armar el maquetado HTML y CSS/SASS
* Armar con React
* Crear la App
